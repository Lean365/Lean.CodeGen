...
public class LeanLoginExtend : LeanBaseEntity
{
    ...
    /// 第一次登录的设备ID
    /// </remarks>
    [SugarColumn(ColumnName = "first_device_id", ColumnDescription = "首次登录设备", Length = 100, IsNullable = true, ColumnDataType = "nvarchar")]
    ...
    /// 最后一次登录的设备ID
    /// </remarks>
    [SugarColumn(ColumnName = "last_device_id", ColumnDescription = "末次登录设备", Length = 100, IsNullable = true, ColumnDataType = "nvarchar")]
