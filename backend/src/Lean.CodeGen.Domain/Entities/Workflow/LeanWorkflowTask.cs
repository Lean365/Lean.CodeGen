...
/// 工作流任务实体
/// </summary>
[SugarTable("lean_wk_task", "工作流任务表")]
...
public class LeanWorkflowTask : LeanBaseEntity
{
  ...
  /// 操作人ID
  /// </summary>
  [SugarColumn(ColumnName = "operator_id", ColumnDescription = "操作人ID", IsNullable = true)]
  public long? OperatorId { get; set; }

  /// <summary>
  /// 操作人名称
  /// </summary>
  [SugarColumn(ColumnName = "operator_name", ColumnDescription = "操作人名称", Length = 50, IsNullable = true)]
