...
/// 字典类型实体
/// </summary>
[SugarTable("lean_adm_dict_type_type", "字典类型表")]
[SugarIndex("idx_type_code", nameof(DictTypeCode), OrderByType.Asc, true)]
public class LeanDictType : LeanBaseEntity
{
    ...
    /// </remarks>
    [SugarColumn(ColumnName = "dict_type_name", ColumnDescription = "字典名称", Length = 100, IsNullable = false, ColumnDataType = "nvarchar")]
    ...
    /// </remarks>
    [SugarColumn(ColumnName = "dict_type_code", ColumnDescription = "字典编码", Length = 100, IsNullable = false, ColumnDataType = "nvarchar")]
    ...
    /// </remarks>
    [SugarColumn(ColumnName = "dict_type_category", ColumnDescription = "字典分类", IsNullable = false, DefaultValue = "0", ColumnDataType = "int")]
    ...
    /// 字典类型状态：0-正常，1-停用
    /// </remarks>
    [SugarColumn(ColumnName = "dict_type_status", ColumnDescription = "状态", IsNullable = false, DefaultValue = "0", ColumnDataType = "int")]
