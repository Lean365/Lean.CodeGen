...
namespace Lean.CodeGen.Domain.Entities.Generator
{
  ...
  public class LeanDbColumn : LeanBaseEntity
  {
    ...
    /// 标识该列是否为主键
    /// </remarks>
    [SugarColumn(ColumnName = "is_pk", ColumnDescription = "是否主键", IsNullable = false, ColumnDataType = "int")]
    ...
    /// 标识该列是否为自增列
    /// </remarks>
    [SugarColumn(ColumnName = "is_increment", ColumnDescription = "是否自增", IsNullable = false, ColumnDataType = "int")]
    ...
    /// 标识该列是否允许为空值
    /// </remarks>
    [SugarColumn(ColumnName = "is_nullable", ColumnDescription = "是否允许为空", IsNullable = false, ColumnDataType = "int")]
    ...
    /// 标识该字段在表单中是否必填
    /// </remarks>
    [SugarColumn(ColumnName = "is_required", ColumnDescription = "是否必填", IsNullable = false, ColumnDataType = "int")]
    ...
    /// 标识该字段是否为插入字段
    /// </remarks>
    [SugarColumn(ColumnName = "is_insert", ColumnDescription = "是否为插入字段", IsNullable = false, ColumnDataType = "int")]
    ...
    /// 标识该字段是否为编辑字段
    /// </remarks>
    [SugarColumn(ColumnName = "is_edit", ColumnDescription = "是否编辑字段", IsNullable = false, ColumnDataType = "int")]
    ...
    /// 标识该字段是否在列表页面显示
    /// </remarks>
    [SugarColumn(ColumnName = "is_list", ColumnDescription = "是否列表字段", IsNullable = false, ColumnDataType = "int")]
    ...
    /// 标识该字段是否作为查询条件
    /// </remarks>
    [SugarColumn(ColumnName = "is_query", ColumnDescription = "是否查询字段", IsNullable = false, ColumnDataType = "int")]
    ...
    /// 标识该字段是否作为导入字段
    /// </remarks>
    [SugarColumn(ColumnName = "is_import", ColumnDescription = "是否导入字段", IsNullable = false, ColumnDataType = "int")]
    ...
    /// 标识该字段是否作为导出字段
    /// </remarks>
    [SugarColumn(ColumnName = "is_export", ColumnDescription = "是否导出字段", IsNullable = false, ColumnDataType = "int")]
    ...
    /// 标识该字段是否为业务键
    /// </remarks>
    [SugarColumn(ColumnName = "is_business_key", ColumnDescription = "是否业务键", IsNullable = false, ColumnDataType = "int")]
    ...
    /// 标识该字段是否为版本字段
    /// </remarks>
    [SugarColumn(ColumnName = "is_version", ColumnDescription = "是否版本字段", IsNullable = false, ColumnDataType = "int")]
