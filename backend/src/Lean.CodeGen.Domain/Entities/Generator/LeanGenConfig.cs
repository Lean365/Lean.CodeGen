...
namespace Lean.CodeGen.Domain.Entities.Generator
{
    ...
    public class LeanGenConfig : LeanBaseEntity
    {
        ...
        /// 生成代码时是否覆盖已存在的文件
        /// </remarks>
        [SugarColumn(ColumnName = "is_override", ColumnDescription = "是否覆盖已有文件", IsNullable = false, ColumnDataType = "bit")]
        public bool IsOverride { get; set; }

        /// <summary>
        /// 是否移除表前缀
        /// </summary>
        [SugarColumn(ColumnName = "is_remove_prefix", ColumnDescription = "是否移除表前缀", IsNullable = false, ColumnDataType = "bit")]
