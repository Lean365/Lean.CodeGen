...
namespace Lean.CodeGen.Application.Services.Audit
{
  ...
  public interface ILeanAuditLogService
  {
    ...
    Task<LeanPageResult<LeanAuditLogDto>> GetPageListAsync(LeanAuditLogQueryDto queryDto);
    ...
    Task<LeanFileResult> ExportAsync(LeanAuditLogQueryDto queryDto);
