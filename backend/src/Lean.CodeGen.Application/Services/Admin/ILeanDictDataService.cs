...
public interface ILeanDictDataService
{
    ...
    /// 创建字典数据
    /// </summary>
    Task<LeanApiResult<long>> CreateAsync(LeanDictDataCreateDto input);

    /// <summary>
    /// 更新字典数据
    /// </summary>
    Task<LeanApiResult> UpdateAsync(LeanDictDataUpdateDto input);
    ...
    /// 分页查询字典数据
    /// </summary>
    Task<LeanApiResult<LeanPageResult<LeanDictDataDto>>> GetPageAsync(LeanDictDataQueryDto input);

    /// <summary>
    /// 修改字典数据状态
    /// </summary>
    Task<LeanApiResult> SetStatusAsync(LeanDictDataChangeStatusDto input);
    ...
    /// 导出字典数据
    /// </summary>
    Task<byte[]> ExportAsync(LeanDictDataQueryDto input);
