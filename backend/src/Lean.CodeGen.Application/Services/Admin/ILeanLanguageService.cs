...
public interface ILeanLanguageService
{
    ...
    /// 创建语言
    /// </summary>
    Task<LeanApiResult<long>> CreateAsync(LeanLanguageCreateDto input);

    /// <summary>
    /// 更新语言
    /// </summary>
    Task<LeanApiResult> UpdateAsync(LeanLanguageUpdateDto input);
    ...
    /// 分页查询语言
    /// </summary>
    Task<LeanApiResult<LeanPageResult<LeanLanguageDto>>> GetPageAsync(LeanLanguageQueryDto input);

    /// <summary>
    /// 修改语言状态
    /// </summary>
    Task<LeanApiResult> SetStatusAsync(LeanLanguageChangeStatusDto input);
    ...
    Task<byte[]> ExportAsync(LeanLanguageQueryDto input);
