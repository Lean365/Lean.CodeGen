...
public class LeanOnlineMessageController : LeanBaseController
{
    ...
    /// </summary>
    [HttpPost]
    public async Task<IActionResult> SendAsync([FromBody] LeanOnlineMessageSendDto input)
    {
    ...
    /// </summary>
    [HttpGet("export")]
    public async Task<IActionResult> ExportAsync([FromQuery] LeanOnlineMessageQueryDto queryDto)
    {
    ...
    public async Task<IActionResult> MarkMessagesAsRead([FromBody] LeanOnlineMessageMarkAsReadDto request)
    {
